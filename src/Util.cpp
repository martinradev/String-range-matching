...
vector<size_t> str::retrieveRangeIndices(const dynamic_bitset<> & lowbits, const dynamic_bitset<> & topbits)
{
    /*
    ...
    */
    const dynamic_bitset<> XOR = lowbits ^ topbits;
    ...
    */
    vector<size_t> positions(XOR.count());
